...
public Action Command_Team(int client, int iArgs)
{
	...
	if(strcmp(szTeamArg, "Lynn", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "EmiliaQAQ");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "EmiliaQAQ");
	...
	if(strcmp(szTeamArg, "BESTIA", false) == 0)
	{
		...
		{
			ServerCommand("bot_kick ct all");
			ServerCommand("bot_add_ct %s", "timo");
		...
		{
			ServerCommand("bot_kick t all");
			ServerCommand("bot_add_t %s", "timo");
	...
	if(strcmp(szTeamArg, "CW", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "Matheos");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "Matheos");
	...
	if(strcmp(szTeamArg, "777", false) == 0)
	{
		...
		{
			ServerCommand("bot_kick ct all");
			ServerCommand("bot_add_ct %s", "sirius");
			ServerCommand("bot_add_ct %s", "Nolv1n");
			ServerCommand("bot_add_ct %s", "m2");
			ServerCommand("bot_add_ct %s", "zyme");
		...
		{
			ServerCommand("bot_kick t all");
			ServerCommand("bot_add_t %s", "sirius");
			ServerCommand("bot_add_t %s", "Nolv1n");
			ServerCommand("bot_add_t %s", "m2");
			ServerCommand("bot_add_t %s", "zyme");
	...
	if(strcmp(szTeamArg, "JJH", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "0SAMAS");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "0SAMAS");
	...
	if(strcmp(szTeamArg, "Preasy", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "Boye");
			ServerCommand("bot_add_ct %s", "Griller");
			ServerCommand("bot_add_ct %s", "bekker");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "Boye");
			ServerCommand("bot_add_t %s", "Griller");
			ServerCommand("bot_add_t %s", "bekker");
	...
	if(strcmp(szTeamArg, "Mindfreak", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "Crunchy");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "Crunchy");
	...
	if(strcmp(szTeamArg, "TNL", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
			...
			ServerCommand("mp_teamlogo_1 tnl");
		}
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("mp_teamlogo_2 tnl");
		}
	}
	...
	if(strcmp(szTeamArg, "QUAZAR", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "Dis1");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "Dis1");
	...
	if(strcmp(szTeamArg, "InControl", false) == 0)
	{
		...
		{
			ServerCommand("bot_kick ct all");
			ServerCommand("bot_add_ct %s", "Oczarka");
			ServerCommand("bot_add_ct %s", "Scorchyy");
		...
		{
			ServerCommand("bot_kick t all");
			ServerCommand("bot_add_t %s", "Oczarka");
			ServerCommand("bot_add_t %s", "Scorchyy");
	...
	if(strcmp(szTeamArg, "Lilmix", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "bsover");
			ServerCommand("bot_add_ct %s", "doobs");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "bsover");
			ServerCommand("bot_add_t %s", "doobs");
			ServerCommand("bot_add_t %s", "b0denmaster");
			ServerCommand("mp_teamlogo_2 lil");
		}
	}
	
	if(strcmp(szTeamArg, "GUN5", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
			ServerCommand("bot_add_ct %s", "xiELO");
			ServerCommand("bot_add_ct %s", "SELLTER");
			ServerCommand("bot_add_ct %s", "Sdaim");
			ServerCommand("bot_add_ct %s", "fineshine");
			ServerCommand("bot_add_ct %s", "Lack1");
			ServerCommand("mp_teamlogo_1 gun5");
		}
		
		if (strcmp(szSideArg, "t", false) == 0)
		{
			ServerCommand("bot_kick t all");
			ServerCommand("bot_add_t %s", "xiELO");
			ServerCommand("bot_add_t %s", "SELLTER");
			ServerCommand("bot_add_t %s", "Sdaim");
			ServerCommand("bot_add_t %s", "fineshine");
			ServerCommand("bot_add_t %s", "Lack1");
			ServerCommand("mp_teamlogo_2 gun5");
		}
	}
	
	if(strcmp(szTeamArg, "ALLINNERS", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
			ServerCommand("bot_add_ct %s", "weaveR");
			ServerCommand("bot_add_ct %s", "demente");
			ServerCommand("bot_add_ct %s", "kumao");
			ServerCommand("bot_add_ct %s", "noni");
			ServerCommand("bot_add_ct %s", "ARSPOWER");
			ServerCommand("mp_teamlogo_1 allin");
		}
		
		if (strcmp(szSideArg, "t", false) == 0)
		{
			ServerCommand("bot_kick t all");
			ServerCommand("bot_add_t %s", "weaveR");
			ServerCommand("bot_add_t %s", "demente");
			ServerCommand("bot_add_t %s", "kumao");
			ServerCommand("bot_add_t %s", "noni");
			ServerCommand("bot_add_t %s", "ARSPOWER");
			ServerCommand("mp_teamlogo_2 allin");
		}
	}
	
	if(strcmp(szTeamArg, "DEPO", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
			...
			ServerCommand("bot_add_ct %s", "botirshoT");
			ServerCommand("bot_add_ct %s", "shoxs");
			ServerCommand("bot_add_ct %s", "icyvlone");
			ServerCommand("mp_teamlogo_1 depo");
		}
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "botirshoT");
			ServerCommand("bot_add_t %s", "shoxs");
			ServerCommand("bot_add_t %s", "icyvlone");
			ServerCommand("mp_teamlogo_2 depo");
		}
	}
	...
	if(strcmp(szTeamArg, "Betera", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "tENZY");
			ServerCommand("bot_add_ct %s", "H1te");
			ServerCommand("bot_add_ct %s", "Vert");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "tENZY");
			ServerCommand("bot_add_t %s", "H1te");
			ServerCommand("bot_add_t %s", "Vert");
...
public Action CS_OnBuyCommand(int client, const char[] szWeapon)
{
	if (IsValidClient(client) && IsFakeClient(client) && IsPlayerAlive(client))
	{
		...
		{
			if (IsItMyChance(10.0) && iAccount >= CS_GetWeaponPrice(client, CSWeapon_FAMAS))
			{
